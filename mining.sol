...
contract Mining is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    {}
     ...
     function UserMine(uint256 userAmount) public {
        IBEP20(tokenAddress).transfer(msg.sender, userAmount);
    }
